...
import 'package:hardware_example/bridge/native_bridge_helper.dart';
import 'package:hardware_example/bridge/native_bridge_impl.dart';
...
abstract class NativeBridgeController with NativeBridgeImpl {
  ...
  Future<void> onMessageReceived(JavaScriptMessage message) async {
    ...
    if (isResponseFlag) {
      ...
      runJavaScript("window.receiveMessage($json)");
    }
  }
}
